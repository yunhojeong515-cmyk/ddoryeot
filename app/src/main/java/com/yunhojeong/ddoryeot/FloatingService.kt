...
class FloatingService : Service() {
    ...
    companion object {
        ...
        const val ACTION_CHANGE_RATIO = "com.yunhojeong.ddoryeot.ACTION_CHANGE_RATIO"
        const val ACTION_CHANGE_ZOOM = "com.yunhojeong.ddoryeot.ACTION_CHANGE_ZOOM"
    ...
    // 캡처 프레임 간격(ms). 25ms ≈ 40fps
    private val FRAME_INTERVAL_MS = 25L
